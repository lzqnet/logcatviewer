...
import com.zhiqing.logcatdebug.modules.CpuFreqModule;
...
public class DebugOverlay {
    ...
    public static void installDefault(Application application,String tag){
        new DebugOverlay.Builder(application)
            .modules(//new CpuUsageModule(),
                //new MemInfoModule(this),
                new FpsModule(),
                new LogcatModule(50,  new TagAndPriorityFilter(LogcatLine.Priority.VERBOSE,tag)))
